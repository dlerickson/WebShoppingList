...
public class StartProgram {
		...
		private static void addAnItem() {
			...
			//call method from ListItemHelper to add an item
		...
		private static void deleteAnItem() {
			...
			String item = in.nextLine();
			//calling that deleteItem() in that ListItemHelper
		...
		private static void editAnItem() {
			...
			if (searchBy == 1) {
				...
				foundItems = lih.searchForItemByStore(storeName);//find by store
			} else {
				System.out.print("Enter the item: ");
				String itemName = in.nextLine();
				foundItems = lih.searchForItemByItem(itemName);//or find by item
